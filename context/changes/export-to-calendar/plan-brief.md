...
## What
Add calendar export to milestone results. Users click calendar icon → enter label → select provider (Google/Apple/Outlook) → deep link opens with pre-filled event.
...
**Implementation:**
- Phase 0: Refactor Event.label format (remove "+" prefix, add in JSX)
...
**Key decisions:**
- Phase 0 prerequisite: Refactor Event.label to remove "+" prefix (store "10,000 days", add "+" in component JSX)
- Event title: "[Event.label] milestone of [User Label]" (e.g., "10,000 days milestone of Wedding")
